          ...
          <div className="space-y-8 animate-fade-in-up">
            <div className="space-y-6">
              ...
              <div className="inline-flex items-center gap-2 bg-primary/10 backdrop-blur-sm text-primary px-4 py-2 rounded-full text-sm font-medium border border-primary/20 floating-badge">
                <Star className="w-4 h-4 animate-pulse" />5 estrelas · 500+
              ...
              <h1 className="text-6xl md:text-7xl font-bold leading-tight tracking-tight">
                ...
                <span className="text-accent-foreground">Simplificada.</span>
              </h1>

              {/* Description */}
              <p className="text-xl text-input-foreground tracking-tight font-medium leading-relaxed max-w-xl backdrop-blur-sm">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-4 bg-gradient-to-br from-primary/10 to-primary/5 backdrop-blur-sm rounded-xl border border-primary/20">
                    <div className="text-2xl font-bold text-primary animate-pulse tracking-tight">
                      99.9%
                    </div>
