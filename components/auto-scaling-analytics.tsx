...
export default function AutoScalingAnalytics() {
  ...
  return (
    <section className="pt-4 pb-16">
      <div className="container border border-border grid grid-cols-2 grid-rows-2 mx-auto">
        <div className="flex flex-col justify-between flex-1 border-r border-r-border overflow-clip h-[512px] p-0">
          ...
          <div className="flex h-full w-full justify-center items-center overflow-clip">
            <DataFlowIllustration />
          </div>
        </div>
        <div className="flex flex-col justify-between overflow-clip h-[512px] p-0">
          <div className="flex flex-col items-start p-6">
          ...
          <div className="h-80 w-full justify-end overflow-clip">
            <ChartContainer className="aspect-auto w-full scale-105 h-80" config={chartConfig}>
        ...
        <div className="flex flex-col justify-between border-t border-t-border col-span-2 w-full overflow-clip h-[446px] p-0">
          <div className="flex flex-col items-start p-6">
            <h3 className="text-2xl font-semibold text-foreground mb-1 tracking-tight">
              Empresas crescem 5x mais rápido
            </h3>
          ...
          <div className="h-80 w-full justify-end overflow-clip col-span-12">
            <ChartContainer className="aspect-auto h-80 scale-115 w-full" config={chartConfig}>
              <AreaChart data={scalingData}>
                <defs>
                  <linearGradient
                    id="scalingGradient"
